...
public class EventOwner extends Person {
    ...
    public EventOwner(String oName, String ownerType, String uName, String Email, String phoneNumber, int requestNumber) {
        super(uName, Email, phoneNumber, uType);
        EventOwner.oName = oName;
        EventOwner.ownerType = ownerType;
        EventOwner.requestNumber = requestNumber;
    }
    ...
    public static void newUser(ArrayList<EventOwner> ownerRequest){       
        boolean check;
        do{
        System.out.println("Enter user name: ");
        uName = in.next();
        check = uNameCheck(ownerRequest);
        ...
        phoneNumber = in.next();
        requestNumber++;
        ownerRequest.add(new EventOwner (oName, ownerType,uName,Email,phoneNumber, requestNumber));
        int option =0;
        Events.showEvent();
